...
(function () {
  ...
  const factorsWorkingWellChart = document.getElementById('factorsWorkingWellChart');
  if (factorsWorkingWellChart) {
    const factorsWorkingWellChartVar = new Chart(factorsWorkingWellChart, {
      type: 'bar',
      data: {
        labels: ['Environment', 'Physiological Needs', 'Policies'], // Factors working well
        datasets: [
          {
            data: [85, 75, 90], // Percentage or scores for each factor
            backgroundColor: ['#4CAF50', '#8BC34A', '#CDDC39'], // Shades of Green for factors working well
            borderColor: 'transparent',
            maxBarThickness: 30
          }
        ]
  ...
  const factorsNotWorkingWellChart = document.getElementById('factorsNotWorkingWellChart');
if (factorsNotWorkingWellChart) {
  const factorsNotWorkingWellChartVar = new Chart(factorsNotWorkingWellChart, {
    type: 'bar',
    data: {
      labels: ['Reward and Recognition', 'Reputation', 'Learning'], // Factors not working well
      datasets: [
        {
          data: [60, 40, 50], // Percentage or scores for each factor
          backgroundColor: ['#F44336', '#E91E63', '#FF5722'], // Shades of Red for factors not working well
          borderColor: 'transparent',
          maxBarThickness: 30
        }
      ]
