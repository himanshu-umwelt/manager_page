...
(function () {
  ...
  leadsReportChartConfig = {
    ...
    labels: ['Negative', 'Positive', 'Neutral', 'No Match'],
    series: [375, 675, 300, 150], // Adjust percentages as per the actual data
    colors: ['#fc4c4c', '#71ba51', '#fcad3f', '#757575'], // Red, Green, Yellow, Grey
    stroke: {
      width: 0
    },
    dataLabels: {
